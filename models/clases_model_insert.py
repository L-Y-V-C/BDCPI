...
def create_mesabillar(data_base, mesabillar_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_mesabillar('{}', '{}', '{}', '{}', '{}', '{}');""".format(
...
def create_checkoutmesa(data_base, checkoutmesa_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_checkoutmesa('{}', '{}', '{}', '{}');""".format(
...
def create_ambiente(data_base, ambiente_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_ambiente('{}', '{}', '{}');""".format(
...
def create_empleado(data_base, empleado_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_empleado('{}', '{}', '{}', '{}', '{}', '{}', '{}');""".format(
...
def create_mantenimiento(data_base, mantenimiento_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_mantenimiento('{}', '{}');""".format(
...
def create_local(data_base, local_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_local('{}', '{}', '{}');""".format(
...
def create_equipamiento(data_base, equipamiento_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_equipo('{}', '{}', '{}', '{}', '{}');""".format(
...
def create_proveedor(data_base, proveedor_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_proveedor('{}', '{}', '{}', '{}');""".format(
...
def create_pedido_consumible(data_base, pedido_consumible_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_pedidoConsumible('{}', '{}', '{}');""".format(
...
def create_consumible(data_base, consumible_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_consumible('{}', '{}', '{}', '{}');""".format(
...
def create_ingrediente(data_base, ingrediente_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_ingrediente('{}', '{}', '{}');""".format(
...
def create_mesacomida(data_base, mesacomida_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_mesacomida('{}', '{}', '{}');""".format(
...
def create_pago(data_base, pago_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_pago('{}', '{}', '{}');""".format(
...
def create_local_consumible(data_base, local_consumible_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_local_consumible('{}', '{}');""".format(
...
def create_pedido_consumible_consumible(data_base, pedido_consumible_consumible_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_pedidoconsumible_consumible('{}', '{}');""".format(
...
def create_ingrediente_consumible(data_base, ingrediente_consumible_obj):
    cursor = data_base.connection.cursor()
    sql_command = """CALL db_billar.insert_ingrediente_consumible('{}', '{}');""".format(
